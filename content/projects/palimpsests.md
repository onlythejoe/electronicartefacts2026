...
stakeholders:
  - id: ea:organization:electronic-artefacts
constraints:
  - Preserve the autonomy of the artistic work.
...
outputs:
  - id: ea:project:palimpsests
outcomes:
  - A public cultural dossier around memory and transmission.
  - A model for linking artistic production to research and archive systems.
evidence:
  - id: ea:program:oreth
credits:
  - id: ea:organization:electronic-artefacts
...
The project should preserve not only final releases but also references, visual plates, research notes and structural decisions. The archive should remain selective. A good archive does not publish everything; it preserves enough provenance for future interpretation.
