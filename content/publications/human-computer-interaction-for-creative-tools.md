...
abstract: This article explains HCI for creative tools, focusing on feedback, agency, flow, error recovery, accessibility, augmented intelligence and computational media.
...
citation:
  preferred: "Electronic Artefacts. \"Human Computer Interaction for Creative Tools.\" Technical article, version 1.0.0, 2026."
tags:
  - HCI
  - Creative Tools
...
Electronic Artefacts already has the technical entities for this discussion: [VASTE](/programs/vaste/), [Contextual Execution](/knowledge/concepts/contextual-execution/) and [Motion Design](/knowledge/concepts/motion-design/).
...
From there, the path should lead to [Augmented Intelligence](/knowledge/concepts/augmented-intelligence/), [Motion Design](/knowledge/concepts/motion-design/), [Generative AI](/knowledge/concepts/generative-ai/) and [VASTE](/programs/vaste/). This makes HCI a bridge between interface craft and systems research.
...
Continue with [Hypertext and Augmented Knowledge Systems](/publications/hypertext-and-augmented-knowledge-systems/) and [Generative AI, Latent Space and Creative Workflows](/publications/generative-ai-latent-space-and-creative-workflows/).
...
- Electronic Artefacts. VASTE and Contextual Execution records.
