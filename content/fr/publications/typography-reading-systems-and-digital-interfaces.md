...
abstract: Typographie, systèmes de lecture et interfaces numériques examine le sujet "Typographie,
  systèmes de lecture et interfaces numériques" dans le graphe public d'Electronic Artefacts. La
  fiche en synthétise les architectures, les usages, les limites et les sources de référence.
description: Typographie, systèmes de lecture et interfaces numériques examine le sujet
  "Typographie, systèmes de lecture et interfaces numériques" dans le graphe public d'Electronic
