...
abstract: C2PA, Content Credentials et provenance des médias génératifs examine le sujet "C2PA,
  Content Credentials et provenance des médias génératifs" dans le graphe public d'Electronic
  Artefacts. La fiche en synthétise les architectures, les usages, les limites et les sources de
  référence.
description: C2PA, Content Credentials et provenance des médias génératifs examine le sujet "C2PA,
  Content Credentials et provenance des médias génératifs" dans le graphe public d'Electronic
  Artefacts. La fiche en synthétise les architectures, les usages, les limites et les sources de
  référence.
locale: fr
