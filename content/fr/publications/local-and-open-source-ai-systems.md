...
Cette synthèse clarifie le sujet « Systèmes d’IA locaux et open source » pour aider le lecteur à comprendre le vocabulaire, les enjeux pratiques et les liens avec les autres pages du graphe Electronic Artefacts.
