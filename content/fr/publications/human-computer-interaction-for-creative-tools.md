...
Electronic Artefacts a déjà les entités techniques pour cette discussion: [VASTE](/fr/programs/vaste/), [Exécution contextuelle](/fr/knowledge/concepts/contextual-execution/) et [Conception de mouvement](/fr/knowledge/concepts/motion-design/).
...
Continuer avec [Hypertexte et systèmes de connaissances améliorés](/fr/publications/hypertext-and-augmented-knowledge-systems/) et [L'IA, l'espace latent et les flux de travail créatifs](/fr/publications/generative-ai-latent-space-and-creative-workflows/).
