...
Lire [Données liées](/fr/knowledge/concepts/linked-data/), [Graphe de connaissances](/fr/knowledge/concepts/knowledge-graph/), [Métadonnées](/fr/knowledge/concepts/metadata/), [Identité de l'entité](/fr/knowledge/concepts/entity-identity/) et [Génération augmentée par récupération](/fr/knowledge/concepts/retrieval-augmented-generation/).

## Technologies connexes

Voir [JSON-LD](/fr/knowledge/technologies/json-ld/) et [RDF](/fr/knowledge/technologies/rdf/).
