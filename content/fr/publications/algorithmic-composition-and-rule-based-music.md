...
Le chemin suivant devrait conduire à [Système générateur](/fr/knowledge/concepts/generative-system/), [Rétroaction cybernétique](/fr/knowledge/concepts/cybernetic-feedback/), [Audio Web](/fr/knowledge/concepts/web-audio/) et [ORETH](/fr/programs/oreth/). Cela maintient la production musicale liée au plus large Knowledge Hub plutôt qu'isolée comme une catégorie de tutoriels.
...
Lire [Composition algorithmique](/fr/knowledge/concepts/algorithmic-composition/), [Système générateur](/fr/knowledge/concepts/generative-system/), [Rétroaction cybernétique](/fr/knowledge/concepts/cybernetic-feedback/), [Audio Web](/fr/knowledge/concepts/web-audio/) et [ORETH](/fr/programs/oreth/).
...
Continuer avec [Systèmes génériques, cybernétique et codage créatif](/fr/publications/generative-systems-cybernetics-and-creative-coding/) et [Systèmes sonores audio Web et basés sur le navigateur](/fr/publications/web-audio-and-browser-based-sound-systems/).
