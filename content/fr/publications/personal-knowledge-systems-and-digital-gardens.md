...
Un parcours de lecture utile commence par une question pratique: comment puis-je garder les idées connectées au fil du temps? De là, l'article doit guider le lecteur vers [Hypertexte](/fr/knowledge/concepts/hypertext/), [Métadonnées](/fr/knowledge/concepts/metadata/) et [Préservation numérique](/fr/knowledge/concepts/digital-preservation/). Cette route transforme un sujet familier de productivité en une architecture plus profonde de la mémoire et de la publication.
...
Lire [Système de connaissances personnelles](/fr/knowledge/concepts/personal-knowledge-system/), [Hypertexte](/fr/knowledge/concepts/hypertext/), [Graphe de connaissances](/fr/knowledge/concepts/knowledge-graph/), [Métadonnées](/fr/knowledge/concepts/metadata/) et [Préservation numérique](/fr/knowledge/concepts/digital-preservation/).
...
Continuer avec [Hypertexte et systèmes de connaissances améliorés](/fr/publications/hypertext-and-augmented-knowledge-systems/) et [Métadonnées, catalogage et mémoire culturelle](/fr/publications/metadata-cataloguing-and-cultural-memory/).
