---
id: ea:publication:open-source-as-cultural-infrastructure-fr
type: publication
slug:
...
Un visiteur de recherche peut arriver à travers une question pratique sur open source, le codage créatif ou la culture logicielle. L'article devrait déplacer ce lecteur de licence vers l'infrastructure: qui maintient le code, ce qui en dépend, comment il enseigne et comment il peut être préservé. De là, le chemin naturel mène à [Codage créatif](/fr/knowledge/concepts/creative-coding/), [Préservation numérique](/fr/knowledge/concepts/digital-preservation/) et les archives logicielles futures.
...
Lire [Source ouverte](/fr/knowledge/concepts/open-source/), [Codage créatif](/fr/knowledge/concepts/creative-coding/), [Culture Internet](/fr/knowledge/concepts/internet-culture/) et [Préservation numérique](/fr/knowledge/concepts/digital-preservation/).
...
Continuer avec [Pédagogie de codage créatif de Logo à p5.js](/fr/publications/creative-coding-pedagogy-from-logo-to-p5js/) et [Conservation numérique et archives vivantes](/fr/publications/digital-preservation-and-living-archives/).
