...
abstract: Exécution contextuelle désigne le sujet "Exécution contextuelle" dans le graphe public
...
description: Exécution contextuelle désigne le sujet "Exécution contextuelle" dans le graphe public
  d'Electronic Artefacts. La fiche en précise l'usage, les limites et les relations avec les
  projets, technologies et publications d'Electronic Artefacts.
locale: fr
visibility: public
...
Exécution contextuelle désigne le sujet "Exécution contextuelle" dans le graphe public d'Electronic Artefacts.
