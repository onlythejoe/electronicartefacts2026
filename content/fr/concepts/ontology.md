---
id: ea:concept:ontology-fr
type: concept
slug:
  canonical: ontology
title: Ontologie
definition: Ontologie désigne les modèles conceptuels qui définissent classes, propriétés, relations
  et contraintes d'un domaine.
abstract: Ontologie désigne les modèles conceptuels qui définissent classes, propriétés, relations
  et contraintes d'un domaine. La fiche en précise l'usage, les limites et les relations avec les
  projets, technologies et publications d'Electronic Artefacts.
description: Ontologie désigne les modèles conceptuels qui définissent classes, propriétés,
  relations et contraintes d'un domaine. La fiche en précise l'usage, les limites et les relations
...
Ontologie désigne les modèles conceptuels qui définissent classes, propriétés, relations et contraintes d'un domaine.
