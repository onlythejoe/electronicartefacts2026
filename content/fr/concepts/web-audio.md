...
definition: Audio web désigne les API audio du navigateur et les systèmes sonores interactifs
  produits sur le Web.
abstract: Audio web désigne les API audio du navigateur et les systèmes sonores interactifs produits
  sur le Web. La fiche en précise l'usage, les limites et les relations avec les projets,
  technologies et publications d'Electronic Artefacts.
description: Audio web désigne les API audio du navigateur et les systèmes sonores interactifs
  produits sur le Web. La fiche en précise l'usage, les limites et les relations avec les projets,
  technologies et publications d'Electronic Artefacts.
locale: fr
visibility: public
...
Audio web désigne les API audio du navigateur et les systèmes sonores interactifs produits sur le Web.
