...
test("the published runtime provides progressive page and media transitions", async () => {
  ...
  assert.match(home, /assets\/js\/app\.js\?v=73/);
  assert.match(project, /assets\/css\/project\.css\?v=1/);
  assert.match(project, /assets\/js\/app\.js\?v=73/);
  ...
  assert.match(graph, /assets\/js\/app-full\.js\?v=73/);
  assert.match(search, /assets\/js\/app-full\.js\?v=73/);
});
