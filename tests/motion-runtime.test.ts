...
test("the published runtime provides progressive page and media transitions", async () => {
  ...
  assert.match(graph, /assets\/js\/app-full\.js\?v=75/);
  assert.match(search, /assets\/js\/app-full\.js\?v=75/);
});
