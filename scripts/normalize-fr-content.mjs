...
const titleMap = new Map(Object.entries({
  ...
  "Open Weight Model": "Modele a poids ouverts",
  ...
  "Procedural Graphics": "Graphisme procedural",
  "Procedural Graphics, Shaders and Visual Systems": "Graphisme procedural, shaders et systemes visuels",
  ...
  "Retrieval-Augmented Generation": "Generation augmentee par recuperation",
  "Retrieval-Augmented Generation and Knowledge Systems": "Generation augmentee par recuperation et systemes de connaissance",
  "Runtime Engines and Domain Operating Systems": "Moteurs runtime et systemes d'exploitation de domaine",
  ...
  "Verifiable Credentials for Cultural Archives and Creator Identity": "Identifiants verifiables pour les archives culturelles et l'identite des createurs",
  "Web Audio": "Audio web",
