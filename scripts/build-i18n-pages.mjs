        ...
        <section class="zone-card hero home-cinematic-hero intent-hero intent-hero--home">
          <div class="intent-hero__grid home-cinematic-hero__layout">
            ...
            <aside class="intent-hero__stage home-intent-stage" data-intent-stage aria-label="Projets actuels d’Electronic Artefacts">
              ...
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--lead" data-entry-id="voice-capture-studio" data-depth="0.82" data-home-project-card>
                <a class="home-project-hologram__link" href="/fr/projects/voice-capture-studio/" aria-label="Ouvrir Voice Capture Studio"><span class="home-project-hologram__visual"><img src="/assets/media/projects/voice-capture-studio/voice-capture-studio-capture-640.webp" alt="Écran de capture Voice Capture Studio" loading="eager" fetchpriority="high" /></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--voice"><i></i><i></i><i></i><i></i></span></span><span><small>Notre prochain projet phare</small><strong>Voice Capture Studio</strong></span></span><span class="home-project-hologram__detail"><span>Capture locale, corpus continu et exports de texte temporisé.</span><small><i></i>Développement</small></span></a>
              ...
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--vaste" data-entry-id="vaste" data-depth="1.18" data-home-project-card>
                <a class="home-project-hologram__link" href="/fr/programs/vaste/" aria-label="Ouvrir VASTE"><span class="home-project-hologram__visual"><span class="home-project-hologram__graph" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><b></b></span></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--vaste">V<span>·</span></span></span><span><small>Runtime expérimental</small><strong>VASTE</strong></span></span><span class="home-project-hologram__detail"><span>Un runtime graph-native portable, contextuel et gouverné.</span><small><i></i>Développement</small></span></a>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--innerside" data-entry-id="innerside" data-depth="1.48" data-home-project-card>
                <a class="home-project-hologram__link" href="/fr/projects/innerside/" aria-label="Ouvrir InnerSide"><span class="home-project-hologram__visual"><span class="home-project-hologram__threshold" aria-hidden="true"><i></i><b>INNER<br />SIDE</b></span></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--innerside"><i></i><b>IS</b></span></span><span><small>RED DOOR × EA</small><strong>InnerSide</strong></span></span><span class="home-project-hologram__detail"><span>Produit émergent porté par RED DOOR, façonné avec Electronic Artefacts.</span><small><i></i>Recherche</small></span></a>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--proof" data-entry-id="oeil-de-meg" data-depth="1.62" data-home-project-card>
                <a class="home-project-hologram__link" href="/fr/project.html?id=oeil-de-meg" aria-label="Ouvrir L’Œil de Meg"><span class="home-project-hologram__visual"><img src="/assets/media/projects/oeil-de-meg/oeil-de-meg-logo.webp" alt="Signature L’Œil de Meg" loading="lazy" /></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--eye">Œ</span></span><span><small>Projet client livré</small><strong>L’Œil de Meg</strong></span></span><span class="home-project-hologram__detail"><span>Identité, narration et plateforme numérique pour la photographie.</span><small><i></i>Production</small></span></a>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
