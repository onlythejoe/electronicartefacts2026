...
const frenchHomeShell = `      <section data-render="home-hero" data-runtime-static="true">
        <section class="zone-card hero home-cinematic-hero intent-hero intent-hero--home">
          <div class="intent-hero__grid home-cinematic-hero__layout">
            <div class="hero-copy intent-hero__copy">
              ...
              <h1 class="display-title">Rendre les systèmes numériques complexes lisibles.</h1>
              <p class="lede">Electronic Artefacts est un studio indépendant de technologies créatives. Nous concevons des produits clients, développons des systèmes propriétaires et publions des travaux culturels issus de la recherche.</p>
              <div class="button-row">
                <a class="button button--primary" href="/fr/work.html">Voir les réalisations</a>
                <a class="button button--secondary" href="/fr/contact.html">Parler d’un projet</a>
              </div>
              <div class="pill-cloud intent-hero__chips" aria-label="Pratiques du studio">
                <span class="chip">Produits clients</span><span class="chip">Systèmes propriétaires</span><span class="chip">Outils open source</span><span class="chip">Recherche</span><span class="chip">Édition artistique</span>
              </div>
            </div>
            <aside class="intent-hero__stage home-intent-stage" data-intent-stage aria-label="Projets actuels d’Electronic Artefacts">
              <div class="intent-hero__stage-label"><span>Sélection</span><strong>Systèmes actuels et projets livrés</strong></div>
              <div class="home-intent-stage__orbit" aria-hidden="true"></div>
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--lead" data-entry-id="voice-capture-studio" data-depth="0.82" data-home-project-card tabindex="0" aria-label="Aperçu du projet : Voice Capture Studio">
                <div class="home-project-hologram__link"><span class="home-project-hologram__visual"><img src="/assets/media/projects/voice-capture-studio/voice-capture-studio-capture-640.webp" alt="Écran de capture Voice Capture Studio" loading="eager" fetchpriority="high" /></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--voice"><i></i><i></i><i></i><i></i></span></span><span><small>Notre prochain projet phare</small><strong>Voice Capture Studio</strong></span></span><span class="home-project-hologram__detail"><span class="home-project-hologram__detail-copy">Capture locale, corpus continu et exports de texte temporisé.</span><span class="home-project-hologram__detail-meta"><small><i></i>Développement</small><a class="home-project-hologram__open" href="/fr/projects/voice-capture-studio/" data-home-card-open>Accéder au projet <span aria-hidden="true">↗</span></a></span></span></div>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--vaste" data-entry-id="vaste" data-depth="1.18" data-home-project-card tabindex="0" aria-label="Aperçu du projet : VASTE">
                <div class="home-project-hologram__link"><span class="home-project-hologram__visual"><span class="home-project-hologram__graph" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><b></b></span></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--vaste">V<span>·</span></span></span><span><small>Runtime expérimental</small><strong>VASTE</strong></span></span><span class="home-project-hologram__detail"><span class="home-project-hologram__detail-copy">Un runtime graph-native portable, contextuel et gouverné.</span><span class="home-project-hologram__detail-meta"><small><i></i>Développement</small><a class="home-project-hologram__open" href="/fr/programs/vaste/" data-home-card-open>Accéder au projet <span aria-hidden="true">↗</span></a></span></span></div>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--innerside" data-entry-id="innerside" data-depth="1.48" data-home-project-card tabindex="0" aria-label="Aperçu du projet : InnerSide">
                <div class="home-project-hologram__link"><span class="home-project-hologram__visual"><span class="home-project-hologram__threshold" aria-hidden="true"><i></i><b>INNER<br />SIDE</b></span></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo" aria-hidden="true"><span class="home-project-logo home-project-logo--innerside"><i></i><b>IS</b></span></span><span><small>RED DOOR × EA</small><strong>InnerSide</strong></span></span><span class="home-project-hologram__detail"><span class="home-project-hologram__detail-copy">Produit émergent porté par RED DOOR, façonné avec Electronic Artefacts.</span><span class="home-project-hologram__detail-meta"><small><i></i>Recherche</small><a class="home-project-hologram__open" href="/fr/projects/innerside/" data-home-card-open>Accéder au projet <span aria-hidden="true">↗</span></a></span></span></div>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
              <article class="home-intent-stage__frame home-project-hologram home-intent-stage__frame--proof" data-entry-id="oeil-de-meg" data-depth="1.62" data-home-project-card tabindex="0" aria-label="Aperçu du projet : L’Œil de Meg">
                <div class="home-project-hologram__link"><span class="home-project-hologram__visual"><img src="/assets/media/projects/oeil-de-meg/oeil-de-meg-logo.webp" alt="Signature L’Œil de Meg" loading="lazy" /></span><span class="home-project-hologram__identity"><span class="home-project-hologram__logo home-project-hologram__logo--interactive"><button class="project-butterfly project-butterfly--hologram" type="button" data-project-butterfly aria-label="Faire battre le papillon de L’Œil de Meg"><span class="project-butterfly__stage" aria-hidden="true"><span class="project-butterfly__hinge project-butterfly__hinge--left"><img class="project-butterfly__wing project-butterfly__wing--left" src="/assets/media/projects/oeil-de-meg/wing.png" alt="" loading="lazy" /></span><span class="project-butterfly__hinge project-butterfly__hinge--right"><img class="project-butterfly__wing project-butterfly__wing--right" src="/assets/media/projects/oeil-de-meg/wing.png" alt="" loading="lazy" /></span></span></button></span><span><small>Projet client livré</small><strong>L’Œil de Meg</strong></span></span><span class="home-project-hologram__detail"><span class="home-project-hologram__detail-copy">Identité, narration et plateforme numérique pour la photographie.</span><span class="home-project-hologram__detail-meta"><small><i></i>Production</small><a class="home-project-hologram__open" href="/fr/project.html?id=oeil-de-meg" data-home-card-open>Accéder au projet <span aria-hidden="true">↗</span></a></span></span></div>
                <span class="home-project-hologram__controls" role="group" aria-label="Redimensionner l’aperçu du projet"><button type="button" data-home-card-size="smaller" aria-label="Réduire l’aperçu">−</button><button type="button" data-home-card-size="reset" aria-label="Réinitialiser la taille">↺</button><button type="button" data-home-card-size="larger" aria-label="Agrandir l’aperçu">+</button></span><button class="home-project-hologram__resize-handle" type="button" data-home-card-resize aria-label="Redimensionner librement l’aperçu"><span></span></button>
              </article>
              <p class="home-intent-stage__hint" aria-hidden="true">Sélectionner · déplacer · redimensionner</p>
            </aside>
          </div>
        </section>
      </section>
